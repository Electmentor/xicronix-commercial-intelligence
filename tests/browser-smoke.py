...
with sync_playwright() as p:
 ...
 try:
  ...
  page.get_by_role('button',name='Abrir expediente comercial').click();check('commercial dossier opens',lambda:expect(page.locator('#leadDetailTitle')).to_contain_text('Expediente Comercial'));check('situation and action visible',lambda:expect(page.locator('#leadDetailContent')).to_contain_text('SITUACIÓN'));check('deliverables radiography visible',lambda:expect(page.locator('#leadDetailContent')).to_contain_text('Entregables'));page.locator('#closeLeadDetail').click()
