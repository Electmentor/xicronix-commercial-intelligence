...
files=['index.html','app.js','styles.css','executive.css','analytics.css','production.css','domain.mjs','workspace.mjs','demo.mjs','executive.mjs','analytics.mjs','analytics-view.mjs','catalog.mjs','commercial-core.mjs','seller-dashboard.mjs','recuperar.html','recuperar.js','complaints.html']
results={'checked_at':datetime.now(timezone.utc).isoformat(),'base_url':base,'release':'2026-09-25-v2.44.2','assets':[],'logged_out_browser':False}
def fetch(path):
