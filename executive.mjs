...
export function renderExecutive(data,{now=new Date(),demo=false,failures={},analyticsPeriod='year'}={}){
 ...
 ][index];return '<div class="director-pipeline-stage director-pipeline-stage--clone" style="--pipe:'+color+'"><span class="stage-accent"></span><span class="stage-icon stage-icon--glow">'+icons+'</span><strong>'+count+'</strong><small>'+label+'</small></div>';}).join('')+'</div></section>'+
