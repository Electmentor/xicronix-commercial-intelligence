...
export function renderExecutive(data,{now=new Date(),demo=false,failures={},analyticsPeriod='year'}={}){
 ...
 const mobileClone='<section class="mobile-clone-dashboard" aria-label="Dashboard comercial móvil">'+
  '<header class="mobile-clone-header"><div class="mobile-clone-logo"><strong>Xicroni<span>x</span></strong><small>COMMERCIAL INTELLIGENCE</small></div><button class="mobile-clone-avatar" id="mobileMenuAlias" type="button" aria-label="Abrir menú">☰</button></header>'+
