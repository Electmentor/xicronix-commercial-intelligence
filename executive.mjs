...
export function renderExecutive(data,{now=new Date(),demo=false,failures={},analyticsPeriod='year'}={}){
 ...
 const mobileClone='<section class="mobile-clone-dashboard" aria-label="Dashboard comercial móvil">'+
  ...
  '<section class="mobile-clone-kpis">'+
   '<button data-page="prospects" data-prospect-kpi="ALL" aria-label="Prospectos"><span class="blue">●</span><strong>'+prospects.length+'</strong><small>P</small></button>'+
   ...
   '<button data-page="prospects" data-prospect-kpi="ACTION_NOW" aria-label="Alta prioridad"><span class="red">▲</span><strong>'+topHighPriority+'</strong><small>AP</small></button>'+
   '<button data-page="prospects" data-prospect-kpi="REVIEW" aria-label="En revisión"><span class="violet">▣</span><strong>'+reviewFirst.length+'</strong><small>ER</small></button>'+
  '</section>'+
